...
<li class="breadcrumb-item active breadcrumb_heading" style="font-weight:bold;"> Form D Details</li>
</ol>
...
<div class="container" style="margin-bottom: 100px;">
              <div class="form-group row">
                <div class="col-sm-12">
                	...
                	<a href="{{url('/form-ca')}}" class="btn btn-primary float-right">Back</a>
                </div>
              </div>
    <div class="row">
        <!--form data start-->
        <div class="col-md-5">
            ...
            <form>
              <div class="form-group row">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control" id="principle_amt" name="principle_amt" value="{{$user->principle}}" readonly >
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-5 col-form-label">Interest</label>
                <div class="col-sm-7">
                  <input type="text" class="form-control" id="interest" name="interest" value="{{$user->intrest}}" readonly>
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-7">
                  <select class="form-control" id="claim_nature" name="claim_nature" autocomplete="off" readonly>
                      <option>Default select</option>
                      <option value="1" {{(isset($cat->claim_nature) && $cat->claim_nature=='workmen') ? 'selected' : ''}}>Workmen</option>
                      <option value="2" {{(isset($cat->claim_nature) && $cat->claim_nature=='employee') ? 'selected' : ''}}>Employee</option>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          ...
                                          <input type="radio" id="report" name="radio" value="{{$fm->id}}" onchange="getReport('{{$fm->form_d_selected_id}}','{{$fm->id}}','get-form-d-pdf-report','pdfBReport')" autocomplete="off">
                                        </td>
                                    </tr>
                                    @empty
                                    <tr>
