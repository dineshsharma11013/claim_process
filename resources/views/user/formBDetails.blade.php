...
<li class="breadcrumb-item active breadcrumb_heading" style="font-weight:bold;"> Form B Details</li>
</ol>
...
<div class="container" style="margin-bottom: 100px;">
              <div class="form-group row">
                <div class="col-sm-12">
                	...
                	<a href="{{url('/form-b')}}" class="btn btn-primary float-right">Back</a>
                </div>
              </div>
    <div class="row">
        <!--form data start-->
        <div class="col-md-5">
            ...
            <form>
              <div class="form-group row">
                <label for="" class="col-sm-5 col-form-label">Principal Amt.</label>
                <div class="col-sm-7">
                  <input type="text" class="form-control" id="principle_amt" name="principle_amt" value="{{isset($cat->principal_amt) ? $cat->principal_amt : $user->principle_amount}}" readonly >
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-5 col-form-label">Interest</label>
                <div class="col-sm-7">
                  <input type="text" class="form-control" id="interest" name="interest" value="{{isset($cat->interest) ? $cat->interest : $user->interest}}" readonly>
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-5 col-form-label">Total</label>
                <div class="col-sm-7">
                  <input type="text" class="form-control" id="total_amount" name="total_amount" value="{{isset($cat->total) ? $cat->total : $user->total_amount}}" readonly>
                </div>
              </div>
              ...
              <hr>
              <span>Amount Admitted</span>
              <hr>
              
              <div class="form-group row">
                <label for="" class="col-sm-5 col-form-label">Principal Amt.</label>
                <div class="col-sm-7">
                  <input type="text" class="form-control" id="approved_principle_amt" name="approved_principle_amt" value="{{isset($cat->approved_principle_amt) ? $cat->approved_principle_amt : ''}}" readonly >
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-5 col-form-label">Interest</label>
                <div class="col-sm-7">
                  <input type="text" class="form-control" id="approved_interest_amt" name="approved_interest_amt" value="{{isset($cat->approved_interest_amt) ? $cat->approved_interest_amt : ''}}" readonly>
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-5 col-form-label">Total</label>
              ...
              <hr>
              <span>Amount of claim not admitted</span>
              <hr>

              <div class="form-group row">
                <label for="" class="col-sm-5 col-form-label">Principal Amt.</label>
                <div class="col-sm-7">
                  <input type="text" class="form-control" id="rejected_principle_amt" name="rejected_principle_amt" value="{{isset($cat->rejected_principle_amt) ? $cat->rejected_principle_amt : ''}}" readonly >
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-5 col-form-label">Interest</label>
                <div class="col-sm-7">
                  <input type="text" class="form-control" id="rejected_interest_amt" name="rejected_interest_amt" value="{{isset($cat->rejected_interest_amt) ? $cat->rejected_interest_amt : ''}}" readonly>
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-5 col-form-label">Total</label>
              ...
              <hr>
              <span>Amount of claim under verfication</span>
              <hr>

              <div class="form-group row">
                <label for="" class="col-sm-5 col-form-label">Principal Amt.</label>
                <div class="col-sm-7">
                  <input type="text" class="form-control" id="pending_principle_amt" name="pending_principle_amt" value="{{isset($cat->pending_principle_amt) ? $cat->pending_principle_amt : ''}}" readonly >
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-5 col-form-label">Interest</label>
                <div class="col-sm-7">
                  <input type="text" class="form-control" id="pending_interest_amt" name="pending_interest_amt" value="{{isset($cat->pending_interest_amt) ? $cat->pending_interest_amt : ''}}" readonly>
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-5 col-form-label">Total</label>
              ...
              $claimNature = isset($cat->claim_nature) ? $cat->claim_nature : '';
              $clN = '';

              if (!empty($claimNature)) 
              {
                if ($claimNature=='govern') 
                {
                  $clN = 'Government Dues';
                }
                elseif ($claimNature== 'other') 
                {
                  $clN = 'Other than workman, employee and goverment dues';
                }
              }  
              ...
              <div class="form-group row">
                <label for="" class="col-sm-5 col-form-label">Type of operational creditor</label>
                <div class="col-sm-7">
                  <input type="text" class="form-control" id="claim_nature" name="claim_nature" value="{{$clN}}" readonly>
                </div>
              </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          ...
                                          <input type="radio" id="report" name="radio" value="{{$fm->id}}" onchange="getReport('{{$fm->form_b_selected_id}}','{{$fm->id}}','get-form-b-pdf-report','pdfBReport')" autocomplete="off">
                                        </td>
                                    </tr>
                                    @empty
                                    <tr>
