...
<li class="breadcrumb-item active breadcrumb_heading" style="font-weight:bold;"> Form CA Details</li>
</ol>
        ...
        <div class="col-md-5">
            ...
            <form>
              <div class="form-group row">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control" id="principle_amt" name="principle_amt" value="{{$user->claim_principle}}" readonly >
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-5 col-form-label">Interest</label>
                <div class="col-sm-7">
                  <input type="text" class="form-control" id="interest" name="interest" value="{{$user->claim_interest}}" readonly>
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-5 col-form-label">Total</label>
                <div class="col-sm-7">
                  <input type="text" class="form-control" id="total_amount" name="total_amount" value="{{$user->claim_amt}}" readonly>
                </div>
              </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          ...
                                          <input type="radio" id="report" name="radio" value="{{$fm->id}}" onchange="getReport('{{$fm->form_ca_selected_id}}','{{$fm->id}}','get-form-ca-pdf-report','pdfBReport')" autocomplete="off">
                                        </td>
                                    </tr>
                                    @empty
                                    <tr>
