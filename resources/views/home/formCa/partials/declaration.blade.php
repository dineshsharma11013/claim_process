              ...
              @foreach($senctionDetails as $fl)
                ...
                <button class="btn btn-primary btn-sm" type="button" id="deleteRowBtn{{$loop->index+1}}" onclick="delSenction('{{$loop->index+1}}', 'sanctionAmtTbl', '{{$fl->id}}', '/remove-senction-data', 'deleteRowBtn', 'financialCreditorFormCA', 'errMessage_4', '{{Config::get('site.formCASenctionMdl')}}')">Delete Row</button></td>
                </tr>
              ...
              @foreach($declarationMdls as $fl)
                ...
                <button class="btn btn-primary btn-sm" type="button" id="deleteRowBtn{{$loop->index+1}}" onclick="delSenction('{{$loop->index+1}}', 'sanctionDeclTbl', '{{$fl->id}}', '/remove-senction-data', 'deleteRowBtn', 'financialCreditorFormCA', 'errMessage_4', '{{Config::get('site.formCADecTblMdl')}}')">Delete Row</button></td>
                </tr>
            ...
            a related party of the corporate debtor, as defined under section 5 (24) of the Code.</span><br><br>
              ...
              <span><img class="profile-pic-user" src="{{ asset('public/access/media/forms/formCa/documents/'.$user->unique_id.'/'.$user->fc_signature) }}" width="75" height="75" style="float: right;"></span>
