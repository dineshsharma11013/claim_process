 <div class="row">
                    ...
                    <input class="form-check-input" type="checkbox" id="work_purchase_order" name="work_purchase_order" onchange="handleChange('financialCreditorFormCA','work_purchase_order','work_purchase_order_file');" autocomplete="off" @if(isset($user->work_purchase_order)) @if($user->work_purchase_order=='on') checked @endif @endif>
                    ...
                    <div class="col-md-6">
                      ...
                      @if($user->work_purchase_order=='') style="display:none;" @endif
                      @else
                      @endif
                      >
                    </div>
                    ...
                    <div class="col-md-6">
                    <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="invoices" name="invoices" onchange="handleChange('financialCreditorFormCA','invoices','invoices_file');" autocomplete="off" @if(isset($user->invoices)) @if($user->invoices=='on') checked @endif @endif>
                    ...
                    <input class="form-check-input" type="checkbox" id="balance_confirmation" name="balance_confirmation" onchange="handleChange('financialCreditorFormCA','balance_confirmation','balance_confirmation_file');" autocomplete="off" @if(isset($user->balance_confirmation)) @if($user->balance_confirmation=='on') checked @endif @endif>
                    ...
                    <div class="row">
                    <div class="col-md-6"><div class="form-check">
                    <input class="form-check-input" type="checkbox" id="any_correspondence" name="any_correspondence" onchange="handleChange('financialCreditorFormCA','any_correspondence','any_correspondence_file');" autocomplete="off" @if(isset($user->any_correspondence)) @if($user->any_correspondence=='on') checked @endif @endif>
                    ...
                    <div class="row">
                    <div class="col-md-6"><div class="form-check">
                    <input class="form-check-input" type="checkbox" name="authorisation_letter" id="authorisation_letter" onchange="handleChange('financialCreditorFormCA','authorisation_letter','authorisation_letter_file');" autocomplete="off" @if(isset($user->authorisation_letter)) @if($user->authorisation_letter=='on') checked @endif @endif>
                    ...
                    <div class="row">
                    <div class="col-md-6"><div class="form-check">
                    <input class="form-check-input" type="checkbox" id="bank_statement" name="bank_statement" onchange="handleChange('financialCreditorFormCA','bank_statement','bank_statement_file');" autocomplete="off" @if(isset($user->bank_statement)) @if($user->bank_statement=='on') checked @endif @endif> 
                    ...
                    <div class="row">
                    <div class="col-md-6"><div class="form-check">
                    <input class="form-check-input" type="checkbox" id="ledger_copy" name="ledger_copy" onchange="handleChange('financialCreditorFormCA','ledger_copy','ledger_copy_file');" autocomplete="off" @if(isset($user->ledger_copy)) @if($user->ledger_copy=='on') checked @endif @endif>
                    ...
                    <div class="row">
                    <div class="col-md-6"><div class="form-check">
                    <input class="form-check-input" type="checkbox" name="computation_sheet" id="computation_sheet" onchange="handleChange('financialCreditorFormCA','computation_sheet','computation_sheet_file');" autocomplete="off" @if(isset($user->computation_sheet)) @if($user->computation_sheet=='on') checked @endif @endif>
