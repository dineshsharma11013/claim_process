 @forelse($other_files as $fl)
                <tr id="row{{$loop->index+1}}">
                  ...
                  <td><input type='file' name="other_doc_file[]" onchange="updateFile('financialCreditorForm','/update-formc-file','{{$fl->id}}','{{$loop->index}}', '{{$tbl}}')">
                  ...
                  <td> 
                    @if($loop->index+1 == 1)
                    <button class="btn btn-primary btn-sm" type="button" id="addMore" onclick="myFunction()">Add More</button>
                    @endif
              <button class="btn btn-primary btn-sm" type="button" id="deleteRowBtn{{$loop->index+1}}" onclick="del('{{$loop->index+1}}', '{{$fl->id}}', '/remove-formc-data', 'deleteRowBtn', 'financialCreditorForm', 'errMessage_4')">Delete Row</button></td>
                </tr>
                @empty
                <tr id="row1">
              ...
              <button class="btn btn-primary btn-sm" type="button" onclick="del('1')">Delete Row</button></td>
                ...
                <!-- <tr><td><button class="btn btn-primary btn-sm" type="button" id="addMore" onclick="myFunction()">Add More</button></td></tr> -->
                @endforelse
