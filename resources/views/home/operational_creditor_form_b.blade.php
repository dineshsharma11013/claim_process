       ...
       <input type="hidden" name="updated_data" id="updated_data" value="">
            ...
            <div class="tab" id="tab1">
              ...
              <h6 class="text-center">(Under Regulation 7 of the Insolvency and Bankruptcy Board of India (Insolvency Resolution Process for Corpotate Persons) Regulations, 2016)</h6>
               ...
               <h4>From</h4>
                    ...
                    <p><span id="operational_creditor_name">{{!empty($user->operational_creditor_name) ? $user->operational_creditor_name : ''}}</span>  
                      <br> <span id="operational_creditor_address">{{isset($user->operational_creditor_address) ? $user->operational_creditor_address : ''}}</span>
                    </p>

              <h4>To</h4>

              <p>The Interim Resolution Professional / Resolution Professional <br> 
                {{$irp->username}}<br> 
              {{$irp->address}}
              </p>
              ...
              <p class="text-dark">I <span id="operational_creditor_name">{{!empty($user->operational_creditor_name) ? $user->operational_creditor_name : ''}}</span>, hereby submits this proof of claim in respect of the corporate insolvency resolution process in the case of {{isset($comp->name) ? ucwords($comp->name) : ''}}. The details for the same are set our below.</p>
                ...
                <label>1. NAME OF OPERATIONAL CREDITOR <span id="error_sign">*</span> </label>
                  ...
                  <input class="form-control" type="text" placeholder="First name..." id="operational_creditor_name" name="operational_creditor_name" value="{{!empty($user->operational_creditor_name) ? $user->operational_creditor_name : ''}}" onKeyUp="Removefd('operationalCreditorForm','operational_creditor_name');getName('operationalCreditorForm', 'operational_creditor_name', this.value)" autocomplete="off">
                ...
                <input class="form-control" type="text" value="{{isset($user->operational_creditor_address) ? $user->operational_creditor_address : ''}}" placeholder="Address..." id="operational_creditor_address" name="operational_creditor_address" onKeyUp="Removefd('operationalCreditorForm', 'operational_creditor_address');getAddress('operationalCreditorForm', 'operational_creditor_address', this.value)" autocomplete="off">
            ...
            <div class="col-sm-4">
             ...
             <div class="col-sm-4">
              ...
              <button class="btn btn-primary btnclr" type="button" id="firstStep" onclick="nextStepWithValidation2('tab1', 'tab2', 'step1', 'step2', check0)" >Next</button>
            ...
            <div class="tab" id="tab2">
              ...
              <button class="btn btn-primary btnclr" type="button" id="prevBtn" onclick="prev('tab2','tab1','step2','step1')">Previous</button>

              <!-- <button class="btn btn-primary btnclr" type="button" id="secondStep" onclick="validateData('operationalCreditorForm','secondStep','tab2', 'tab3', check1, 'step2', 'step3', '/form/operational-creditor-form-b', 'errMessage_2', updateFileData,'/form/get-formb-updated-fileData', '/form/get-formb-updated-table');getSignature('/get-formB-signature', 'step3Sign');" >Next</button> -->
             ...
             <div class="row border  mb-3 p-2">
              ...
              <button class="btn btn-primary btnclr" type="button" id="forthStep" onclick="validateData2('operationalCreditorForm','forthStep','tab3', 'tab4', check2, 'step3', 'step4', '/form/operational-creditor-form-b-submit', 'errMessage_4','/form/get-formb-updated-table');declaration('declarationDiv', '{{isset($user->id) ? $user->id : ''}}', '', '/get-formB-signature', 'step4Sign');" >Next</button>
            ...
            <div class="tab" id="tab5">
              ...
              <div id="step5Sign" style="text-align: center;margin-top: 40px;"></div>


               <button class="btn btn-primary btnclr" type="button" id="prevBtn" onclick="prev('tab5','tab4','step5','step4');declaration('declarationDiv', '{{isset($user->id) ? $user->id : ''}}', '', '/get-formB-signature', 'step4Sign');">Previous</button>
