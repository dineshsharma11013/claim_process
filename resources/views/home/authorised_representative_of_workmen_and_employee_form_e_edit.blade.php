   ...
   @if(isset($emps) && count($emps)>0)
    ...
    @endif
      ...
      <button class="btn btn-primary btn-sm" type="button" id="append_onclick" onclick="del2()">Delete Row</button>
                ...
                <p>(Signature of financial creditor or person authorised to act on its behalf)<br>[Please enclose the authority if this is being submitted on behalf of the financial creditor]</p></div>
            ...
            <div class="tab" id="tab2">
             ...
             <button class="btn btn-primary" type="button" id="thirdStep" onclick="validateData2('financialCreditorFormE','thirdStep','tab2', 'tab3', check1, 'step2', 'step3', '/form/financial-creditor-form-e-save', 'errMessage_3','/form/get-formE-updated-table');declaration('declarationDiv', '{{isset($user->id) ? $user->id : ''}}', '{{isset($edit) ? 'edit' : ''}}', '/get-formE-signature', 'step3Sign');" >Next</button>
            ...
            <div class="tab" id="tab3">
             ...
             <button class="btn btn-primary" type="button" id="prevBtn" onclick="prev('tab3','tab2','step3','step2');updateTableData('financialCreditorFormE','myTable1','/form/get-formE-updated-table');">Previous</button>
              <!-- <button class="btn btn-primary" type="button" id="secondStep" onclick="validateData('financialCreditorFormE','secondStep','tab2', 'tab3', check0, 'step2', 'step3', '/form/financial-creditor-form-e', 'errMessage_2')" >Next</button> -->
              <button class="btn btn-primary" type="button" id="secondStep" onclick="validateData('financialCreditorFormE','firstStep','tab3', 'tab4', check0, 'step3', 'step4', '/form/financial-creditor-form-e','errMessage_2', getPreview);" >Next</button>
            ...
            <div class="tab" id="tab4">
              ...
              <br><br>
             <button class="btn btn-primary" type="button" id="prevBtn" onclick="prev('tab4','tab3','step4','step3');updateTableData('financialCreditorFormE','myTable1','/form/get-formE-updated-table');">Previous</button>
