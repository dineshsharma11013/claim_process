<center><h5 class="text-center text-uppercase" style="color: #e0363c;" >PROOF OF CLAIM BY CREDITORS (OTHER THAN FINANCIAL CREDITORS AND OPERATIONAL CREDITORS)</h5></center>
              
              <h6 class="text-center">[Under Regulation 9A of the Insolvency and Bankruptcy Board of India (Insolvency Resolution Process for Corporate Persons) Regulations, 2016]</h6>
             ...
             <div class="row">
              ...
              <p class="text-dark">I {{!empty($user->fc_name) ? $user->fc_name : ''}}, hereby submits this proof of claim in respect of the corporate insolvency resolution process in the case of {{!empty($comp->name) ? ucwords($comp->name) : ''}}. The details for the same are set our below.</p>
                 </div>
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        <tr>
          <th scope="row">1.</th>
          <td colspan="4" class="myDIV"> Name of  creditor</td>
          <td colspan="4">{{!empty($user->fc_name) ? $user->fc_name : ''}}</td>
         
        </tr>
        <tr>
          <th scope="row">2.</th>
          <td colspan="4" class="myDIV"> Identification number of  creditor <br> (If an incorporate body provide of incorporation. If a partnership or individual provide identification records* of all the partners or the individual)</td>
        ...
        <tr>
          <th scope="row">3.</th>
          <td colspan="4" class="myDIV">a. Address of  creditor for correspondence</td>
        ...
        <tr>
          <th scope="row">4.</th>
          <td colspan="4" class="myDIV"> Description of the claim (Including the amount of the claim as at the insolvency commencement date)</td>
          <td colspan="4">{{isset($user->claim_amt) ? 'Amount is Rs.'.$user->claim_amt : ''}} {{isset($user->claim_amt_desc) ? $user->claim_amt_desc : ''}}</td>
        </tr>
        ...
        <tr>
          <th scope="row">6.</th>
          <td colspan="4" class="myDIV"> Details of how and when the claim arose</td>
          <td colspan="4">{{isset($user->claim_details) ? $user->claim_details : ''}}</td>
        </tr>
          ...
          <tr><td colspan="4" class="myDIV">IFSC code</td>   <td>{{isset($user->bank_ifsc_code) ? $user->bank_ifsc_code : ''}}</td> </tr>
            ...
            <img class="profile-pic-user" src="{{ asset('public/access/media/forms/formF/documents/'.$user->unique_id.'/'.$user->fc_signature) }}" width="75" height="75" >
              ...
              <div class="col-md-4 my-2">
                ...
                <span>{{!empty($user->signing_person_name) ? $user->signing_person_name : ''}}</span>
             ...
             <div class="form-group">
                <label> LIST OF DOCUMENTS ATTACHED TO THIS PROOF CLIAM IN ORDER TO PROVE THE EXISTENCE AND NON-PAYMENT OF CLAIM DUE TO THE OPERATIONAL CREDITOR</label><br><br>
                    ...
                    <div class="col-md-6">
                      ...
                      <a href="{{ asset('public/access/media/forms/formF/documents/'.$user->unique_id.'/'.$user->work_purchase_order_file) }}" target="_blank">{{ $user->work_purchase_order_file }}</a>
                    ...
                    <div class="col-md-6">
                      ...
                      <a href="{{ asset('public/access/media/forms/formF/documents/'.$user->unique_id.'/'.$user->invoices_file) }}" target="_blank">{{ $user->invoices_file }}</a>
                    ...
                    <div class="col-md-6">
                      ...
                      <a href="{{ asset('public/access/media/forms/formF/documents/'.$user->unique_id.'/'.$user->balance_confirmation_file) }}" target="_blank">{{ $user->balance_confirmation_file }}</a>
                    ...
                    <div class="col-md-6">
                      ...
                      <a href="{{ asset('public/access/media/forms/formF/documents/'.$user->unique_id.'/'.$user->any_correspondence_file) }}" target="_blank">{{ $user->any_correspondence_file }}</a>
                    ...
                    <div class="col-md-6">
                      ...
                      <a href="{{ asset('public/access/media/forms/formF/documents/'.$user->unique_id.'/'.$user->authorisation_letter_file) }}" target="_blank">{{ $user->authorisation_letter_file }}</a>
                    ...
                    <div class="col-md-6">
                      ...
                      <a href="{{ asset('public/access/media/forms/formF/documents/'.$user->unique_id.'/'.$user->bank_statement_file) }}" target="_blank">{{ $user->bank_statement_file }}</a>
                    ...
                    <div class="col-md-6">
                      ...
                      <a href="{{ asset('public/access/media/forms/formF/documents/'.$user->unique_id.'/'.$user->ledger_copy_file) }}" target="_blank">{{ $user->ledger_copy_file }}</a>
                    ...
                    <div class="col-md-6">
                      ...
                      <a href="{{ asset('public/access/media/forms/formF/documents/'.$user->unique_id.'/'.$user->computation_sheet_file) }}" target="_blank">{{ $user->computation_sheet_file }}</a>
                ...
                <p>
                      ...
                      <a href="{{ asset('public/access/media/forms/formF/documents/'.$user->unique_id.'/'.$user->pan_number_file) }}" target="_blank">{{ $user->pan_number_file }}</a>
                ...
                <p>
                      ...
                      @if($user->passport_file != '' && file_exists('public/access/media/forms/formF/documents/'.$user->unique_id.'/'.$user->passport_file))

                      <a href="{{ asset('public/access/media/forms/formF/documents/'.$user->unique_id.'/'.$user->passport_file) }}" target="_blank">{{ $user->passport_file }}</a>
                ...
                <p>
                      ...
                      <a href="{{ asset('public/access/media/forms/formF/documents/'.$user->unique_id.'/'.$user->aadhar_card) }}" target="_blank">{{ $user->aadhar_card }}</a>
              ...
              <table id="myTable">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="{{ asset('public/access/media/forms/formF/documents/'.$user->unique_id.'/'.$fl->file) }}" target="_blank">{{ $fl->file }}</a>
            ...
            <div class="form-group"> 
              ...
              <h6>I,{{!empty($user->signing_person_name) ? $user->signing_person_name : ''}}, currently residing at {{isset($user->signing_address) ? $user->signing_address : ''}} , hereby declare and state as follows:- </h6><br>
            ...
            <img class="profile-pic-user" src="{{ asset('public/access/media/forms/formF/documents/'.$user->unique_id.'/'.$user->fc_signature) }}" width="75" height="75" >
              ...
              <p>I {{!empty($user->signing_person_name) ? $user->signing_person_name : ''}}, the {{!empty($user->creditor_position) ? $user->creditor_position : ''}} hereinabove, do hereby verify that the contents of his proof of claim are true and correct to my Knowledge and belief and no material fact has been concealed therefrom.</p><br>
