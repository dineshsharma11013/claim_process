    ...
    <section class="content">
      <div class="box box-default">
        <div class="box-header with-border">
              ...
              <h3 class="box-title">User Type Info</h3>
        ...
        <div class="box-footer">
                <x-asbutton value="Save" redirect="none" form="generalForm" btnId="formBBtn" path="/add-user-type" btnClass="{{Config::get('site.btnPrimary')}}" :method="$a_vl" />
