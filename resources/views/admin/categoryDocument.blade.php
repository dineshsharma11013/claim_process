    ...
    <section class="content">
      <div class="box box-default">
        <div class="box-header with-border">
              ...
              <h3 class="box-title">Saved Category Document</h3>
...
@endif
        ...
        <form action="{{ route('submit_category_document',['cmid'=>$cmid, 'ctid'=>$ctid]) }}" method="POST" enctype="multipart/form-data">
              @csrf
        <div class="box-body">
         <div class="row">
          <!--  -->
            ...
            <div class="col-md-12">
                ...
                <div class="form-group col-md-6">
                  <label for="exampleInputEmail1">document name <span class="required_cls">*</span></label>
                  <input type="text" name="document_name" class="form-control" placeholder="Enter publication category" autocomplete="off" required>
    ...
    <tr>
        ...
        <td>{{$item->document_name }}</td>
         <td><a href="./../public/publication_category_document/{{$item->document }}" target="_blank"> View document</a></td>
        <td> <a href="{{ route('delete_saved_publication', ['id' => $item->id]) }}" class='btn btn-danger'>Delete</a></td>
        </tr>
@endforeach
            </tbody>
              </table>
