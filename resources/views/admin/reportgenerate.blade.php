  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box box-default">
        ...
        <!-- /.box-header -->
        <form role="form" id="reportForm" action="{{url(admin().'/generateformreport')}}" method="post" onsubmit="return generateReport()">
          @csrf
        <div class="box-body">
          <div class="row">
              ...
              @php 
                ...
                @endphp
                 ...
                 <div class="form-group col-md-3">
                  ...
                  {!! Form::select('company', $company, null, ['onchange' =>'Removef("company")' ,'id' => 'company','class'=>'form-control', 'placeholder'=>'Select Company']) !!}
                ...
                <div class="form-group col-md-3">
                  ...
                  <select class="form-control" name="reprt_typ">
                  <option value="">Select report type</option>
                  <option value="all">All</option>
                  <option value="basic-details">Basic details</option>
                  <option value="claim-details">Claim details</option>
