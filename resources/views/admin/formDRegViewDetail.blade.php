    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header">
              ...
              <h3 class="box-title">Amount claimed by {{ucwords($user->name_in_block_letter)}}</h3>
          <div class="box-tools pull-right">
            <a href="{{url(admin().'/form-d-registered')}}" class="{{Config::get('site.addDataBtn')}}" style="float: right;"><i class="fa fa-arrow-left"></i> Back</a>
          </div>
        </div>
        <!-- /.box-header -->
        ...
        <div class="box-body">
          <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="principle_amt" name="principle_amt" value="{{$user->principle}}" >
                  </div>
                </div>
          <!-- /.row -->
        </div>
        ...
        <div class="box-body">
          <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="interest" name="interest" value="{{$user->intrest}}" >
                  </div>
                </div>
          <!-- /.row -->
        </div>
        ...
        <div class="box-body">
          <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="total_amount" name="total_amount" value="{{$user->total_amount}}" >
                  </div>
                </div>
          <!-- /.row -->
        </div>
          ...
          <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <select class="form-control" id="claim_nature" name="claim_nature" onchange='Removef("claim_nature")' autocomplete="off">
                      ...
                      <option value="workmen" {{(isset($cat->claim_nature) && $cat->claim_nature=='workmen') ? 'selected' : ''}}>Workmen</option>
                      <option value="employee" {{(isset($cat->claim_nature) && $cat->claim_nature=='employee') ? 'selected' : ''}}>Employee</option>
                    </select>
        ...
        <div class="box-footer">
                <x-asbutton value="Save" redirect="self" form="formDApprovalForm" btnId="formDApprBtn" path="/form-d-approval" btnClass="{{Config::get('site.btnPrimary')}}" :method="$a_vl" />
                       
                
                    <button type="reset" class="btn btn-info btn-sm">Reset</button>
                    <button type="button" class="btn btn-danger btn-sm" onclick="sendMail('{{$fid}}','userModal','form-d-mail-rp','formBody','formDApprovalForm')">Mail To {{ucwords($user->name_in_block_letter)}}</button>
                

                    <div class="col-md-12" id="errMessage_formDApprovalForm">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                   ...
                   <td>
                    <a class="btn btn-info btn-sm" href="{{url(admin().'/form-d-documents')}}/{{$fm->id}}" target="_blank" role="button"> <i class="fa fa-eye"></i> </a>
                  </td>
                  <td>
                   <!--   <a href="{{url(admin().'/get-form-d-pdf-report/'.$fm->form_d_selected_id.'/'.$fm->id)}}" target="_blank" id="export" class="btn btn-primary pull-right" style="margin-right: 5px;"><i class="fa fa-file-pdf-o"></i></a> -->

                    <input type="radio" id="report" name="report" value="{{$fm->id}}" onchange="getReport('{{$fm->form_d_selected_id}}','{{$fm->id}}','get-form-d-pdf-report','pdfCReport')" autocomplete="off">
                  </td>
                </tr>
                @endforeach
                </tbody>
      ...
      <div class="box box-default">
        ...
        <!-- <iframe src="{{asset('public/access/media/forms/formD/documents/'.$user->unique_id.'/Form-D.pdf')}}" width="100%" height="800px" style="border:none;"></iframe> -->
