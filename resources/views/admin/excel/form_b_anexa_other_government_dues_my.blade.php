...
$ttl_amnt_cvrd_by_scrt=0;

$ttl_amnt_cvrd_by_grnte=0;
?>
<table style="border: none;border-collapse: collapse;width:749pt;">
    <tbody>
    <tr><td colspan='15' style="text-align:center;font-weight:bold">Annexure-8</td></tr>
...
on: {{date('Y-m-d')}};  </td></tr>
        <tr><td colspan='15' style="text-align:center;font-weight:bold">List of operational creditors (Other than Workmen and Employee Government dues)</td></tr>
        ...
        <tr>
            ...
            <td  rowspan="2" style="color:black;font-weight:700;font-style:normal;text-decoration:none;font-family:Calibri;text-align:center;vertical-align:bottom;border:none;border-top:.5pt solid black;border-right:.5pt solid black;border-bottom:.5pt solid black;border-left:.5pt solid black;word-wrap: break-word;">Name of creditor</td>
        ...
        <tr>
            ...
            <td  style="color:black;font-weight:700;font-style:normal;text-decoration:none;font-family:Calibri;text-align:center;vertical-align:top;border:none;border-top:none;border-right:.5pt solid black;border-bottom:.5pt solid black;border-left:.5pt solid black;width:47pt;word-wrap: break-word;">Amount covered by security interest</td>
            
            <td  style="color:black;font-weight:700;font-style:normal;text-decoration:none;font-family:Calibri;text-align:center;vertical-align:top;border:none;border-top:none;border-right:.5pt solid black;border-bottom:.5pt solid black;border-left:.5pt solid black;width:47pt;word-wrap: break-word;">Amount covered by guarantee</td>
            
            <td  style="color:black;font-weight:700;font-style:normal;text-decoration:none;font-family:Calibri;text-align:center;vertical-align:top;border:none;border-top:none;border-right:.5pt solid black;border-bottom:.5pt solid black;border-left:.5pt solid black;width:47pt;word-wrap: break-word;">Whether related party</td>
            <td  colspan='1' style="color:black;font-weight:700;font-style:normal;text-decoration:none;font-family:Calibri;text-align:center;vertical-align:top;border:none;border-top:none;border-right:.5pt solid black;border-bottom:.5pt solid black;border-left:.5pt solid black;width:51pt;word-wrap: break-word;">% of voting share in CoC</td>
        </tr>
       ...
       <?php
        ...
        $ttl_amnt_cvrd_by_scrt +=is_numeric($dt->security_interest) ? $dt->security_interest : 0;

$ttl_amnt_cvrd_by_grnte +=is_numeric($dt->guarantee_amt) ? $dt->guarantee_amt : 0;
        ?>
       <tr>
<td style="word-wrap: break-word;"> {{$loop->index+1}}</td>
<td style="word-wrap: break-word;">{{$dt->operational_creditor_name}}</td>
...
<td></td>
<td style="word-wrap: break-word;"><b>{{$ttl_amnt_cvrd_by_scrt ?? ''}}</b></td>
<td style="word-wrap: break-word;"><b>{{$ttl_amnt_cvrd_by_grnte ?? ''}}</b></td>
<td></td>
<td></td>
