          ...
          <div class="box">
            <div class="box-header">
             ...
             <!--  <a href="{{url(admin().'/add-user-type')}}" class="{{Config::get('site.addDataBtn')}}" style="float: right;"><i class="fa fa-plus"></i> ADD user type</a> -->
              <h3 class="box-title"><u>Form B Registered Details {{ (userType()->user_type==2) ? isset(ipRight()->designation) ? ipRight()->designation : '' : ''}}</u></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                  ...
                  <tr>
                   ...
                   <!--  <td>
                    ...
                    <td>
                      ...
                      <a class="{{Config::get('site.detailBtn')}}" href="{{url(admin().'/form-b-registered-details/'.$fid)}}" target="_blank"><i class="fa fa-eye"></i><!--{{$us->id}} -->Details</a>
