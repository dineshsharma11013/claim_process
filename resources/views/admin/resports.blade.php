...
<div class="col-md-3 col-sm-6 col-xs-12">
    <a href="{{url(admin().'/forms-report/'.$id)}}">
<div class="info-box">
<span class="info-box-icon bg-aqua">
    <i class="fa fa-file-text-o" aria-hidden="true"></i>
</span>
<div class="info-box-content">
<h5 class="info-box-text">Generate Reports</h5>
...
<div class="col-md-3 col-sm-6 col-xs-12">
    <a href="{{url(admin().'/forms-generate-report/'.$id)}}">
<div class="info-box">
<span class="info-box-icon bg-red"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></span>
<div class="info-box-content">
<h5 class="info-box-text">Form Generate Reports</h5>
...
<div class="col-md-3 col-sm-6 col-xs-12">
     <a href="{{url(admin().'/forms-annexure-report/'.$id)}}">
<div class="info-box">
<span class="info-box-icon bg-green">
    <i class="fa fa-file-pdf-o" aria-hidden="true"></i>
</span>
<div class="info-box-content">
<h5 class="info-box-text">Form Annexure Reports</h5>
