    ...
    <section class="content">
      <div class="box box-default">
        ...
        <div class="box-footer">
                <x-asbutton value="Save" redirect="none" form="generalForm" btnId="formBBtn" path="/add-ar" btnClass="{{Config::get('site.btnPrimary')}}" :method="$a_vl" />
