    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header">
              ...
              <h3 class="box-title">form CA Amount claimed by {{ucwords($user->fc_name)}}</h3>
        ...
        <div class="box-body">
          <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="rejected_amt_principl" name="rejected_amt_principl"  autocomplete="off" value="{{isset($cat->rejected_principle_amt) ? $cat->rejected_principle_amt : ''}}">
                  </div>
                </div>
          <!-- /.row -->
        </div>
        ...
        <div class="box-body">
          <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="rejected_interest_amt" name="rejected_interest_amt"  autocomplete="off" value="{{isset($cat->rejected_interest_amt) ? $cat->rejected_interest_amt : ''}}">
                  </div>
                </div>
          <!-- /.row -->
        </div>
        ...
        <div class="box-body">
          <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="total_approved_amount" name="total_approved_amount"  autocomplete="off" value="{{isset($cat->total_approval_amt) ? $cat->total_approval_amt : ''}}">
                  </div>
                </div>
        </div>
        ...
        <div class="box-body">
          <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="total_rejected_amount" name="total_rejected_amount"  autocomplete="off" value="{{isset($cat->total_rejected_amt) ? $cat->total_rejected_amt : ''}}">
                  </div>
                </div>
        </div>
        ...
        <div class="box-body">
          <div class="form-group">
                  <label for="inputEmail3" class="col-sm-6 control-label">Secured financial creditors belonging to any class of creditors</label>
                  <div class="col-sm-6">
                    <select class="form-control" id="status" name="status" onchange='Removef("status")'>
        ...
        <div class="box-body">
          <div class="form-group">
                  <label for="inputEmail3" class="col-sm-6 control-label">Unsecured financial creditors belonging to any class of creditors</label>
                  <div class="col-sm-6">
                    <select class="form-control" id="status" name="status" onchange='Removef("status")'>
                      <option value="">Select</option>
                      <option value="1">Yes</option>
        ...
        <div class="box-body">
          <div class="form-group">
                  <label for="inputEmail3" class="col-sm-6 control-label">Covered by security interest</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="total_rejected_amount" name="total_rejected_amount"  autocomplete="off" value="{{isset($cat->total_rejected_amt) ? $cat->total_rejected_amt : ''}}">
                  </div>
                </div>
        ...
        <div class="box-body">
          <div class="form-group">
                  <label for="inputEmail3" class="col-sm-6 control-label">Amount covered by charity</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="total_rejected_amount" name="total_rejected_amount"  autocomplete="off" value="{{isset($cat->total_rejected_amt) ? $cat->total_rejected_amt : ''}}">
                  </div>
                </div>
        ...
        <div class="box-body">
          <div class="form-group">
                  <label for="inputEmail3" class="col-sm-6 control-label">Percentage of holding shares</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="total_rejected_amount" name="total_rejected_amount"  autocomplete="off" value="{{isset($cat->total_rejected_amt) ? $cat->total_rejected_amt : ''}}">
                  </div>
                </div>
        ...
        <div class="box-body">
          <div class="form-group">
                  <label for="inputEmail3" class="col-sm-6 control-label">Amount of contemtation claim</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="total_rejected_amount" name="total_rejected_amount"  autocomplete="off" value="{{isset($cat->total_rejected_amt) ? $cat->total_rejected_amt : ''}}">
                  </div>
                </div>
        ...
        <div class="box-footer">
                <x-asbutton value="Save" redirect="none" form="formCaApprovalForm" btnId="formCaApprBtn" path="/form-ca-approval" btnClass="{{Config::get('site.btnPrimary')}}" :method="$a_vl" />
                       

                    <button type="reset" class="btn btn-info btn-sm">Reset</button>
                   <button type="button" class="btn btn-danger btn-sm" onclick="sendMail('{{$fid}}','userModal','form-ca-mail-rp','formBody','formCApprovalForm')">Mail To {{ucwords($user->fc_name)}}</button>
