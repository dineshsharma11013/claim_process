        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
               <button type="button" onclick="window.history.back();" class="{{Config::get('site.addDataBtn')}}" style="float: right;">Back</button>    <a href="{{url(admin().'/assign-task')}}" class="{{Config::get('site.addDataBtn')}}" style="float: right;"><i class="fa fa-plus"></i> ADD Task</a> 
             
             
             
             
             
              <h3 class="box-title"><u>Assignments Details</u></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
