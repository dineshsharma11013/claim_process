    ...
    <section class="content">
      <div class="box box-default">
        <div class="box-header with-border">
              ...
              <h3 class="box-title">Update Assign IRP/RP/AR</h3>
          ...
          <div class="row">   
            ...
            <div class="col-md-12">
              ...
              <div class="form-group col-md-6">
                  ...
                  {!! Form::select('company', $comps, $cat->company_id, ['onchange' =>'Removef("company")', 'placeholder' => 'Please Select', 'id' => 'company', 'class'=>'form-control', 'autocomplete'=>'off']) !!}
                  <div class="error_cls" id="error_company"></div>
                </div>  

                <div class="form-group col-md-6">
                  <label for="exampleInputEmail1">IP <span class="required_cls">*</span></label>
                  {!! Form::select('ip', $ips, $cat->ip_id, ['onchange' =>'Removef("ip")', 'placeholder' => 'Please Select', 'id' => 'ip', 'class'=>'form-control', 'autocomplete'=>'off']) !!}
              ...
              <div class="form-group col-md-6">
                  ...
                  {!! Form::select('designation', Config::get('site.designation'), $cat->designation, ['onchange' =>'Removef("designation")', 'id' => 'designation', 'class'=>'form-control', 'autocomplete'=>'off']) !!}
                  <div class="error_cls" id="error_designation"></div>
                </div>  

                <div class="form-group col-md-6">
                  <label>Date of Appointment</label>
                  <input type="text" name="appointment_date" id="appointment_date" value="{{$cat->appointment_date}}" autocomplete="off" onclick="Removef('appointment_date')" class="form-control">
        ...
        <div class="box-footer">
                <x-abutton value="Update" redirect="self" form="ipForm" btnId="ipBtn" path="/edit-assign-data/{{$cat->id}}" btnClass="{{Config::get('site.btnPrimary')}}" :method="$a_vl" />
