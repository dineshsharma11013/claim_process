    ...
    <section class="content-header">
      <h1>
        ...
        @foreach(getCompanyDetails() as $iv)
          ...
          <a href="{{url(admin().'/case-list/'.$id)}}" class="btn btn-sm bg-maroon btn-flat" style="margin-right: 5px;" class="btn btn-default pull-right"><i class="fa fa-plus"></i> Assign Case</a>  
          </div>
