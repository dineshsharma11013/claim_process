          ...
          <div class="box">
            <div class="box-header">
             <!--  <a href="{{url(admin().'/add-user-type')}}" class="{{Config::get('site.addDataBtn')}}" style="float: right;"><i class="fa fa-plus"></i> ADD user type</a> -->
              <h3 class="box-title"><u>Form B Unregistered Details</u></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <td>
                        ...
                        <a href="{{url(admin().'/get-form-b-pdf-report/'.$us->form_b_selected_id.'/'.$us->id)}}" target="_blank" id="export" class="btn bg-orange btn-sm" ><i class="fa fa-file-pdf-o"></i> View</a>
                     ...
                     <!--  <a class="{{Config::get('site.deleteDataBtn')}}" onclick="deleteData('/delete-form-c/{{$us->id}}','deleteUserData')" id="deleteUserData" href="javascript:void(0)"><i class="fa fa-trash"></i> Delete</a> -->
