...
@php 
    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header">
              ...
              <h3 class="box-title">Amount claimed by {{ucwords($user->claimant_name)}}</h3>
        ...
        <div class="box-body">
          <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="principle_amt" name="principle_amt" value="{{isset($cat->principal_amt) ? $cat->principal_amt : $user->principle_amount}}" onkeyup ="getTotalAmt('principle_amt','interest','total_amount')" autocomplete="off" >
                  </div>
                </div>
          <!-- /.row -->
        </div>
        ...
        <div class="box-body">
          <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="interest" name="interest" value="{{isset($cat->interest) ? $cat->interest : $user->interest}}" onkeyup ="getTotalAmt('principle_amt','interest','total_amount')" autocomplete="off">
                  </div>
                </div>
          <!-- /.row -->
        </div>
        ...
        <div class="box-body">
          <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="total_amount" name="total_amount" value="{{isset($cat->total) ? $cat->total : $user->total_amount}}" autocomplete="off" >
                  </div>
                </div>
          <!-- /.row -->
        </div>
        ...
        <div class="box-body">
          <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="dept" name="dept"  autocomplete="off" value="{{isset($cat->dept) ? $cat->dept : ''}}">
                  </div>
                </div>
        </div>
        ...
        <div class="box-body">
          <div class="form-group">
                  <label for="inputEmail3" class="col-sm-6 control-label">Government</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="govt" name="govt"  autocomplete="off" value="{{isset($cat->govt) ? $cat->govt : ''}}">
                  </div>
                </div>
        </div>
        ...
        <div class="box-body">
          <div class="form-group">
                  <label for="inputEmail3" class="col-sm-6 control-label">Type of operational creditor</label>
                  <div class="col-sm-6">
                    <select class="form-control" id="claim_nature" name="claim_nature" onchange='Removef("claim_nature")' autocomplete="off">
                      <option value="">Select</option>
                      <option value="govern" {{(isset($cat->claim_nature) && $cat->claim_nature=='govern') ? 'selected' : ''}}>Government Dues</option>
                      <option value="other" {{(isset($cat->claim_nature) && $cat->claim_nature=='other') ? 'selected' : ''}}>Other than workman, employee and goverment dues</option>
                    </select>
    ...
    <div class="box-body">
          <div class="form-group">
                  <label for="inputEmail3" class="col-sm-6 control-label">Claim nature</label>
                  <div class="col-sm-6">
                    <textarea class="form-control" id="claim_nature2" name="claim_nature2" autocomplete="off">{{isset($cat->claim_nature2) ? $cat->claim_nature2 : ''}}</textarea>
        ...
        <div class="box-footer">
                <x-asbutton value="Save" redirect="none" form="formBApprovalForm" btnId="formBApprBtn" path="/form-b-approval" btnClass="{{Config::get('site.btnPrimary')}}" :method="$a_vl" />
                  ...
                  <button type="button" class="btn btn-danger btn-sm" onclick="sendMail('{{$fid}}','userModal','form-b-mail-rp','formBody','userCredentialForm')">Mail To {{ucwords($user->claimant_name)}}</button>
         ...
         @elseif(userType()->user_type==2 && userType()->sub_user=='')
              @if(ipType()->ip_id == userType()->id && ipType()->designation!='AR')
                  <div class="box-footer">
                <x-asbutton value="Save" redirect="none" form="formBApprovalForm" btnId="formBApprBtn" path="/form-b-approval" btnClass="{{Config::get('site.btnPrimary')}}" :method="$a_vl" />
         ...
         @elseif(userType()->user_type==2 && userType()->sub_user!='')
              @if(ipType()->ip_id == userType()->sub_user && ipType()->designation!='AR')
      ...
      <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-info btn-sm" href="{{url(admin().'/form-b-documents')}}/{{$fm->id}}" target="_blank" role="button"> <i class="fa fa-eye"></i> </a>
                  </td>
                  <td>
