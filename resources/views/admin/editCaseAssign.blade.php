    ...
    <section class="content">
      <div class="box box-default">
        <div class="box-header with-border">
              ...
              <h3 class="box-title">Update Assign Case</h3>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group col-md-6">
                  ...
                  {!! Form::select('assigned_to', $users, $cat->assigned_to, ['onchange' =>'Removef("assigned_to")' ,'id' => 'assigned_to','class'=>'form-control', 'autocomplete' => 'off', 'placeholder'=>'Please Select']) !!}
                 ...
                 <option value="{{$ak}}"
                 @php $rights = explode(', ', $cat->cases);  @endphp
        ...
        <div class="box-footer">
                <x-asbutton value="Update" redirect="self" form="caseAssignForm" btnId="formBBtn" path="/edit-assign-case/{{$cmp}}/{{$cat->id}}" btnClass="{{Config::get('site.btnPrimary')}}" :method="$a_vl" />
