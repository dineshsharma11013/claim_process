        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" value="{{$cat->corporate_debtor_name}}" name="corporate_debtor_name" id="corporate_debtor_name" value="" onclick="Removef('corporate_debtor_name')" class="form-control" autocomplete="off" >
                 ...
                 <div class="form-group col-md-3">
                  ...
                  <input type="text" value="{{$cat->debtor_pan}}" name="debtor_pan" id="debtor_pan" value="" onclick="Removef('debtor_pan')" class="form-control" autocomplete="off" >
                  <div class="error_cls" id="error_debtor_pan"></div>
                  </div>
                  <div class="form-group col-md-3">
                  <label>CIN/LLP Number</label>
                  <input type="text" value="{{$cat->debtor_cin_llp}}" name="debtor_cin_llp" id="debtor_cin_llp" value="" onclick="Removef('debtor_cin_llp')" class="form-control" autocomplete="off" >
            ...
            <div class="col-md-12">
              ...
              <div class="form-group col-md-6">
                  ...
                  <input type="text" value="{{$cat->reg_address}}" name="reg_address" id="reg_address" value="" onclick="Removef('reg_address')" class="form-control"  autocomplete="off">
               ...
               <div class="form-group col-md-6">
                  ...
                  <input type="text" value="{{$cat->website}}" name="website" id="website" value="" onclick="Removef('website')" class="form-control" >
          ...
          <div class="col-md-12">
              ...
              <div class="form-group col-md-6">
                  ...
                  <input type="text" value="{{$cat->place_details}}" name="place_details" id="place_details" value="" onclick="Removef('place_details')" class="form-control" autocomplete="off">
                  <div class="error_cls" id="error_place_details"></div>
                  </div>
              
              <div class="form-group col-md-6">
                  <label>Installed capacity of main products/services</label>
                  <input type="text" value="{{$cat->quantity}}" name="quantity" id="quantity" value="" onclick="Removef('quantity')" class="form-control" autocomplete="off">
              ...
              <div class="col-md-12">
               <div class="form-group col-md-6">
                  ...
                  <input type="text" value="{{$cat->value}}" name="value" id="value" value="" onclick="Removef('value')" class="form-control" autocomplete="off" >
               ...
               <div class="form-group col-md-6">
                  ...
                  <input type="text" value="{{$cat->employee_workmen_number}}" name="employee_workmen_number" id="employee_workmen_number" value="" class="form-control" autocomplete="off" >
            ...
            <div class="col-md-12">
               ...
               <div class="form-group col-md-6">
                  ...
                  <input type="text" value="{{$cat->further_details}}" name="further_details" id="further_details" value="" onclick="Removef('further_details')" class="form-control" autocomplete="off" >
                ...
                <div class="form-group col-md-6"> 
                  ...
                  <input type="text" value="{{$cat->information_issue_date}}" name="information_issue_date" id="information_issue_date" value="" onclick="Removef('information_issue_date')" class="form-control" autocomplete="off" >
               ...
               <div class="form-group col-md-6">
                  ...
                  <input type="text" value="{{$cat->eligibility}}" name="eligibility" id="eligibility" value="" class="form-control" autocomplete="off" >
             ...
             <div class="form-group col-md-6">
                  ...
                  <input type="text" value="{{$cat->last_date_recript}}" name="last_date_recript" id="last_date_recript" value="" onclick="Removef('last_date_recript')" class="form-control" autocomplete="off" >
               ...
               <div class="form-group col-md-6">
                  ...
                  <input type="text" value="{{$cat->prov_issue_date}}" name="prov_issue_date" id="prov_issue_date" value="" class="form-control" autocomplete="off" >
            ...
            <div class="form-group col-md-6">
                  ...
                  <input type="text" value="{{$cat->last_date_submission}}" name="last_date_submission" id="last_date_submission" value="" onclick="Removef('last_date_submission')" class="form-control" autocomplete="off" >
               ...
               <div class="form-group col-md-6">
                  ...
                  <input type="text" value="{{$cat->final_issue_date}}" name="final_issue_date" id="final_issue_date" value="" class="form-control" autocomplete="off" >
               ...
               <div class="form-group col-md-6">
                  ...
                  <input type="text" value="{{$cat->resolution_last_date}}" name="resolution_last_date" id="resolution_last_date" value="" class="form-control" autocomplete="off" >
          ...
          <div class="col-md-12">
            ...
            <div class="form-group col-md-6">
                  ...
                  <input type="text" value="{{$cat->process_email}}" name="process_email" id="process_email" value="" class="form-control" autocomplete="off" >
            ...
            <div class="form-group col-md-6">
                  ...
                  {!! Form::select('status', Config::get('site.status'), $cat->status, ['onchange' =>'Removef("status")' ,'id' => 'status','class'=>'form-control', 'autocomplete' => 'off']) !!}
