...
@endif
        ...
        <form action="{{ route('submit_saved_publication') }}" method="POST" enctype="multipart/form-data">
              @csrf
        <div class="box-body">
         <div class="row">
          <!--  -->
            ...
            <div class="col-md-12">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" name="format_name" class="form-control" placeholder="Enter Format name " autocomplete="off" required>
    ...
    <tr>
        ...
        <td>{{$item->format_name }}</td>
         <td><a href="./../public/saved_publication/{{$item->document }}" target="_blank"> View document</a></td>
