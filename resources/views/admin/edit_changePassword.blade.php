    ...
    <section class="content">
      <div class="box box-default">
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-12">
                ...
                <x-input label="Username" type="text" name="username" :value="$cat->username" placeholder="Username" :comp="$comp" :colMd="$sixDiv"/>
        ...
        <div class="box-footer">
                <x-asbutton value="Update" redirect="self" form="changePasswordForm" btnId="formBBtn" path="/change-password" btnClass="{{Config::get('site.btnPrimary')}}" :method="$a_vl" />
