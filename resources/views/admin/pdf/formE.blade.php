    ...
    <div class="container-fluid">
        ...
        <div class="clearfix"></div>
         ...
         <div class="row">
          ...
          <tr><td>{{$loop->index+1}}</td><td>{{isset($emp->emp_type) ? ucwords($emp->emp_type) : ''}}</td><td>{{$emp->employee_name}}</td><td>@if($emp->id_number==1) Pan card @elseif($emp->id_number==2) Passport @elseif($emp->id_number==3) Aadhar card @endif - {{$emp->id_details}}</td> <td>{{$emp->total_amt}}</td> <td>{{$emp->due_amt_period}}</td></tr>
          @endforeach
          @endif  
         </tbody>
            </table>
  ...
  @endforelse
       ...
       <div class="container-fluid my-4 ">
            <div class="row">
                ...
                <p class="fw-bold">I, {{isset($user->name) ? $user->name : $cat->name}}, currently residing at {{isset($user->address) ? $user->address : $cat->address}}, do hereby declare and state as follows: -</p>
                <p>1. {{!empty($comp->name) ? ucwords($comp->name) : ''}}, the corporate debtor was, at the insolvency commencement date, being the {{dateFm3($user->insolvency_commencement_date)}} actually indebted to me for a sum of Rs. {{$total_amt ?? ''}} . </p>
                 <p>2. In respect of my claim of the said sum or any part thereof, I have relied on the documents specified below: [Please list the documents relied on as evidence of claim].</p>
               <p>3. The said documents are true, valid and genuine to the best of my knowledge, information and belief and no material facts have been concealed therefrom.</p>
               <p>4. In respect of the said sum or any part thereof, neither I, nor any person, by my order, to my knowledge or belief, for my use, had or received any manner of satisfaction or security whatsoever, save and except the following:</p>
              ...
              <p>5. {{$user->select_option == 1 ? 'I am' : 'I am not'}} a related party of the corporate debtor, as defined under section 5 (24) of the Code.</p>
              <p>6. I am eligible to join committee of creditors by virtue of proviso to section 21 (2) of the Code even though I am a related party of the corporate debtor.</p>
           <div class="row">
...
<p class="text-end">    @if(isset($user->operational_creditor_signature))
          ...
          <div class="container-fluid my-4 ">
            <div class="row">
                ...
                <p>I,{{isset($user->name) ? $user->name : $cat->name}} the claimant hereinabove, do hereby verify that the contents of his proof of claim are true and correct to my Knowledge and belief and no material fact has been concealed therefrom.</p>
                <div class="row">
