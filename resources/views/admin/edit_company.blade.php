    ...
    <section class="content">
      <div class="box box-default">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="form-group col-md-6">
                  ...
                  {!! Form::select('ip_type', ['cirp'=>'CIRP', 'liquidator'=>'Liquidator'], $cat->ip_type, ['onchange' =>'Removef("ip_type");getIpType(this.value);', 'placeholder' => 'Please Select', 'id' => 'ip_type','class'=>'form-control', 'autocomplete'=>'off']) !!}
                  <div class="error_cls" id="error_ip_type"></div>
                </div>

                <x-input label="Name of Corporate Debtor" type="text" name="name"  placeholder="" :value="$cat->name" :comp="$comp" :colMd="$sixDiv"/>
                
              </div>

              <div class="col-md-12">

                <x-input label="Address of the registered office and principal office (if any) of corporate debtor" type="text" name="address"  placeholder="" :comp="$comp" :colMd="$sixDiv" :value="$cat->address" />

                 <div class="form-group col-md-6">
                  <label for="exampleInputEmail1">PAN Number </label>
                  <input type="text" name="pan_number" id="pan_number" onclick ="RemoveER('pan_number')" value="{{$cat->pan_number}}" class="form-control" autocomplete="off">
              ...
              <div class="col-md-12">
                <x-input label="Authority under which corporate debtor is incorporated / registered" type="text" name="nclt" :value="$cat->nclt"  placeholder="" :colMd="$sixDiv"/>
              ...
              <div class="col-md-12">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" name="nclt_bench" id="nclt_bench" onclick ="RemoveER('nclt_bench')" value="{{$cat->nclt_bench}}" class="form-control" autocomplete="off">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" name="insolvency_commencement_date" id="insolvency_commencement_date" onchange="RemoveER('insolvency_commencement_date');"  value="{{$cat->insolvency_commencement_date}}" class="form-control" autocomplete="off" >
              ...
              <div class="col-md-12">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" name="order_receving_date" id="order_receving_date" onclick ="RemoveER('order_receving_date')" value="{{$cat->order_receving_date}}" class="form-control" autocomplete="off">
                 ...
                 <div class="form-group col-md-6">
                  ...
                  <input type="text" name="claim_filing_date" id="claim_filing_date" onclick ="RemoveER('claim_filing_date')" value="{{$cat->claim_filing_date}}" class="form-control" autocomplete="off">
              ...
              <div class="col-md-12">
                ...
                <x-input label="Email" type="text" name="email" :value="$cat->email"  placeholder="" :colMd="$sixDiv"/>
              </div>
              ...
              <div class="col-md-12">
                <div class="form-group col-md-6">
                 ...
                 <!--   <option value="">Please Select</option> -->
                    ...
                    <option value="{{$ik}}" {{($cat->status == $ik) ? 'selected' : '' }}>{{$iv}}</option>
                  @endforeach
                  </select>
        ...
        <div class="box-footer">
                <x-asbutton value="Save" redirect="none" form="companyForm" btnId="formBBtn" path="/edit-company/{{$cat->id}}" btnClass="{{Config::get('site.btnPrimary')}}" :method="$a_vl" />
