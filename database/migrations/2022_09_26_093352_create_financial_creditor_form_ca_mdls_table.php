...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('financial_creditor_form_ca_mdls', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('ar', 50); 
            $table->string('form_ca_selected_id', 58);  
            $table->string('fc_name', 80);
            $table->string('fc_identification_number', 80);
            $table->string('fc_address', 150);
            $table->string('fc_email', 80);
            $table->string('claim_amt', 80);
            $table->string('claim_principle', 80);
            $table->string('claim_interest', 80);
            ...
            $table->string('insolvency_professional_name', 80);
    ...
    {
        Schema::dropIfExists('financial_creditor_form_ca_mdls');
    }
};
