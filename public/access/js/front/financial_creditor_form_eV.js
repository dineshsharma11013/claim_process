...
function viewData()
{
  ...
  if (view_data != '') 
  {
    $("#financialCreditorFormE :input").prop("disabled", true);
    $("#financialCreditorFormE :button").prop("disabled", false);
    $("#financialCreditorFormE input[id='operationalCreditorFormBtn']").prop("disabled", true);
  }
}
