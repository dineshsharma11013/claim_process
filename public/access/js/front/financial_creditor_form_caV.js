...
function viewData()
{
  ...
  if (view_data != '') 
  {
    $("#financialCreditorFormCA :input").prop("disabled", true);
    $("#financialCreditorFormCA :button").prop("disabled", false);
    $("#financialCreditorFormCA input[id='operationalCreditorFormBtn']").prop("disabled", true);
  }
}
