...
function viewData()
{
  ...
  if (view_data != '') 
  {
    $("#operationalCreditorForm :input").prop("disabled", true);
    $("#operationalCreditorForm :button").prop("disabled", false);
    $("#operationalCreditorForm input[id='operationalCreditorFormBtn']").prop("disabled", true);
  }
}
