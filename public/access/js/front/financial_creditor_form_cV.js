...
function viewData()
{
  ...
  if (view_data != '') 
  {
    $("#financialCreditorForm :input").prop("disabled", true);
    $("#financialCreditorForm :button").prop("disabled", false);
    $("#financialCreditorForm input[id='operationalCreditorFormBtn']").prop("disabled", true);
  }
}
...
var fid = $("#fid").val();
var updated_data = $("#updated_data").val(); 
//console.log(fid, updated_data, getData);
